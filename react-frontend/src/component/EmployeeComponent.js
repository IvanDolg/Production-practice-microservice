    ...
    return (
      <div> <br /> <br />
        <div className='card col-md-6 offset-md-3'>
          <h3 className='text-senter card-header'> View Employee Ditails</h3>
          ...
          <h3 className='text-senter card-header'> View Department Ditails</h3>
          <div className='card-body'>
            <div className='raw'>
          ...
          <h3 className='text-senter card-header'> View Organization Ditails</h3>
          <div className='card-body'>
            <div className='raw'>
